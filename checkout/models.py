...
class Order(models.Model):
    ...
    # As it is a clean general way to structure an order
    ...
    def update_total(self):
        """Update grand total each time a line item is generated """
    ...
    def save(self, *args, **kwargs):
        """Set the order number if it hasn't already been set"""
